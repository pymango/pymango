...
"""
==================================
Discover User Name on Windows/Unix
==================================

.. currentmodule:: mango.utils.getuser

This module contains a function which discovers user name.
...
.. autosummary::
   ...
   lookup_username - Returns user name string.
   getuid - Returns user id integer.
"""
...
lookup_username.__doc__ = \
"""
Returns user-name string.

:type uid: int
:param uid: option user id.

:rtype: :obj:`str`
:return: User name string for current python process.
"""
